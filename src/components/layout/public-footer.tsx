  ...
  return (
    <footer className="mt-20 border-t border-[#E5E7EB] bg-white">
      <div className="mx-auto max-w-[1600px] px-5 py-8 text-center sm:px-8 lg:py-10">
        ...
        <div className="mt-5 hidden text-[13px] leading-6 font-semibold tracking-[-0.02em] text-[#111111] lg:block">
          <p>
        ...
        <dl className="mx-auto mt-5 grid max-w-2xl gap-1 text-left text-xs leading-5 text-[#111111] lg:hidden">
        ...
        <p className="mt-5 text-xs leading-5 font-semibold tracking-[-0.02em] text-[#111111]">
        ...
        <Link
          href="/admin"
          aria-label="관리자 페이지"
          className="mt-3 inline-block text-[11px] text-[#9CA3AF] hover:text-[#155EEF]"
        >
          -
        </Link>
      </div>
