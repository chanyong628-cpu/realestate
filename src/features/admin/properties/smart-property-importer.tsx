  ...
  return (
    <section className="rounded-2xl border-2 border-blue-200 bg-blue-50/60 p-6">
      <div className="flex items-center gap-2">
        <Sparkles className="text-[#155EEF]" size={21} />
      ...
      <div className="mt-5 space-y-4">
        <label className="block">
          ...
          <input
            ...
            className="h-12 w-full rounded-xl border border-blue-200 bg-white px-4 outline-none focus:border-[#155EEF]"
          />
        </label>
        <label className="block">
          ...
          <textarea
            ...
            className="w-full rounded-xl border border-blue-200 bg-white p-4 outline-none focus:border-[#155EEF]"
          />
        </label>
      </div>
      <button
        ...
        className="mt-4 h-12 rounded-xl bg-[#155EEF] px-6 font-black text-white disabled:opacity-40"
      >
        자동 입력
      </button>
    </section>
